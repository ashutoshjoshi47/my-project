...
import { createBlog } from '../controllers/blogController.js';    // Import the controller function that handles creating a blog. Contains the logic to check duplicates and save to DB.
